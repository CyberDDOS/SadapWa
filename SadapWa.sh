...
echo $cy "||     $i Author: CyberDDOS              $cy||"
echo $cy "||     $i Team  : Garuda tersakti 72     $cy||"
echo $cy"<|=======================================|>"
echo
sleep 4
echo $i"<[===============================]>"
...
echo
echo $me"Contact me kalo mau complain : $i 0895358969207"
exit
fi
